...
#  Feb 03, 2020 04:56:22 PM GMT  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 1737x1023+56+23
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe $site_3_0.lab43 \
        -font TkDefaultFont -foreground #ffffff -text {Milton Court Theatre} \
        -background #000066 -height 835 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1710 
    ...
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $site_4_0.scr54 \
        -background $vTcl(actual_gui_bg) -height 74 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 1692 
    ...
    place $site_4_0.scr54 \
        -in $site_4_0 -x 10 -y 20 -width 1692 -relwidth 0 -height 74 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab43 \
        -in $site_3_0 -x 10 -y 20 -width 1710 -relwidth 0 -height 835 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.lab47 \
        -in $site_3_0 -x 10 -y 860 -width 1710 -relwidth 0 -height 105 \
        -relheight 0 -anchor nw -bordermode ignore 
    label $top.lab43 \
        -activebackground #f9f9f9 -activeforeground black -background #550000 \
        -font TkDefaultFont -foreground #aaaaaa \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
