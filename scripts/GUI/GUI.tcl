...
#  Dec 29, 2019 10:29:10 PM GMT  platform: Darwin
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    vTcl::widgets::core::toplevel::createCmd $top -class Toplevel \
        -borderwidth 1 -menu {{}} -background #000000 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    wm focusmodel $top passive
    wm geometry $top 1738x1000+54+23
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    labelframe $site_3_0.lab43 \
        ...
        -highlightbackground $vTcl(actual_gui_bg) -width 850 
    ...
    label $site_5_0.lab46 \
        ...
        -background $vTcl(actual_gui_bg) -font {-family {Arial} -size 30} \
        -foreground #009900 -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -text 99: -width 40 
    ...
    label $site_5_0.lab48 \
        ...
        -highlightcolor black -text {1200 mm/s} 
    vTcl:DefineAlias "$site_5_0.lab48" "AxisSpeed" vTcl:WidgetProc "MainWindow" 1
    label $site_5_0.lab49 \
        -activebackground #f9f9f9 -activeforeground black -background #bcbcbc \
        -font {-family {Arial} -size 16 -weight bold} \
        -foreground $vTcl(actual_gui_fg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -text {Axis 99: Virtual Axis} -width 410 
    ...
    place $site_5_0.lab50 \
        -in $site_5_0 -x 0 -relx 0.827 -y 0 -rely 0.364 -width 71 -relwidth 0 \
    ...
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd $site_4_0.scr54 \
        -background #000050 -height 75 -highlightcolor black -width 125 
    ...
    place $site_4_0.scr54 \
        -in $site_4_0 -x 10 -y 20 -width 1632 -relwidth 0 -height 54 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.lab47 \
        -in $site_3_0 -x 10 -y 880 -width 1670 -relwidth 0 -height 85 \
        -relheight 0 -anchor nw -bordermode ignore 
